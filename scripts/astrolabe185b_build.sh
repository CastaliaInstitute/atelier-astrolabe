...
ASTROLABE185B_PROJECT_VER="${ASTROLABE185B_PROJECT_VER:-0.1.0}"
ASTROLABE185B_CMAKE_ARGS=(-D "ASTROLABE185B_BUILD_VARIANT=${ASTROLABE185B_VARIANT}" -D "PROJECT_VER=${ASTROLABE185B_PROJECT_VER}")
if [[ "${1:-}" == "usb-demo" ]]; then
