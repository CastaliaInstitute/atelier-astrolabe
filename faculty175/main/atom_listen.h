...
#define ATOM_LISTEN_SILENCE_FRAMES 30
#define ATOM_LISTEN_START_FRAMES 4
#define ATOM_LISTEN_RMS_START 800
#define ATOM_LISTEN_RMS_END 360
...
/** Copy stream mask aligned with atom_listen_waveform_copy (255 = sent to STT). */
