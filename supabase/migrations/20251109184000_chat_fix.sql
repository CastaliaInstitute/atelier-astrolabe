-- Ensure chat tables and policies exist (idempotent)
...
CREATE POLICY "rooms are publicly readable" ON public.chat_rooms FOR SELECT USING (true);
...
CREATE POLICY "reactions are publicly readable" ON public.chat_reactions FOR SELECT USING (true);
