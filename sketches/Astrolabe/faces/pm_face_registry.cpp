...
const PmFaceDescriptor kFaces[] = {
    ...
    {ClockFace::Ocarina, "ocarina", "Ocarina", kStandardLowOwnNoMinuteSkip | kHidden, draw_ocarina, tick_ocarina, nullptr, leave_ocarina},
    {ClockFace::Bongo, "bongo", "Bongo", kStandardLowOwnNoMinuteSkip | kHidden, draw_bongo, tick_bongo, nullptr, leave_bongo},
    {ClockFace::Piano, "piano", "Piano", kStandardLowOwnNoMinuteSkip | kHidden, draw_piano, tick_piano, nullptr, leave_piano},
    {ClockFace::Level, "level", "Level", kStandardLowOwnNoMinuteSkip, draw_level, tick_level, nullptr, nullptr},
    {ClockFace::Tuning, "tuning", "Tuning", kStandardLowOwnNoMinuteSkip | kHidden | kNoVoice, draw_tuning, tick_tuning, enter_tuning, leave_tuning},
    {ClockFace::PanDrum, "pandrum", "Pan Drum", kStandardLowOwnNoMinuteSkip | kHidden, draw_pandrum, tick_pandrum, nullptr, leave_pandrum},
