...
|---|---|---|---|---|---|
| Babel Fish 1.75 S3 | `/dev/cu.usbmodem1101` | ESP32-S3, revision v0.2 | `a4:cb:8f:d6:41:94` | Espressif USB JTAG/serial, serial `A4:CB:8F:D6:41:94` | New Babel Fish translator unit; use `waveshare_s3_175_babelfish`. |
