...
- [x] **2026-05-18** Castalian Rhythms on-device fusion and compact daily card: deterministic signal ranking, embedded card templates/safety copy, cycle NVS keys, and stale daily-card cache. PR [#91](https://github.com/CastaliaInstitute/astrolabe/pull/91); Closes [#64](https://github.com/CastaliaInstitute/astrolabe/issues/64). Cloud build passed; on-device serial/NVS QA still operator task.
