...
- [~] **P2** **Sound mandala / Spectrum face** — `ClockFace::Spectrum`: dual radial FFT (**IN** mic inner, **OUT** speaker/TTS outer), `pm_fft` + `pm_audio_analyzer`; serial `face spectrum`. Mandala/kaleidoscope polish TBD.
