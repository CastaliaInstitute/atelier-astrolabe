...
- [~] **P2** **Sound mandala / Spectrum face** — `ClockFace::Spectrum`: polar visualizers (mandala, spectrum, scope, spectrogram, petals, Lissajous); swipe up/down cycles mode; ES7210 + speaker FFT; PWR/BOOT voice off.
