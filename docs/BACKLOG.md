...
- [~] **P2** **Sound mandala / Spectrum face** — `ClockFace::Spectrum`: 20 polar visualizers (audio, breath, generative, ephemeris); swipe up/down cycles mode; ES7210 + speaker FFT; PWR/BOOT voice off.
