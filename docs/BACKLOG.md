...
- [x] **2026-05-18** Faculty ask-faculty clock face: PWR STT route payload for server-side faculty router/`ask-faculty`, NVS recent faculty with up/down cycling, local history/commonplace hints, and PSRAM `faculty-bust` cache status on face. PR [#90](https://github.com/CastaliaInstitute/astrolabe/pull/90); Closes [#35](https://github.com/CastaliaInstitute/astrolabe/issues/35). Hardware QA / integration device gate required before promotion to `main`.
