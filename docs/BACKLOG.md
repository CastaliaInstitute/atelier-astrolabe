...
- [x] **2026-05-18** Daily card clock face and Astrology BOOT: `ClockFace::Rhythms` compact cached Castalian Rhythms card, BOOT card narration, and Astrology BOOT prompt reuse. PR [#92](https://github.com/CastaliaInstitute/astrolabe/pull/92); Closes [#65](https://github.com/CastaliaInstitute/astrolabe/issues/65). Hardware QA on `integration` required before promotion to `main`.
