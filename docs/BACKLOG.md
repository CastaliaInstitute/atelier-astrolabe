...
- [~] **P2** **Sound mandala / Spectrum face** — `ClockFace::Spectrum`: polar mandala (radial spectrum, spectrogram rings, circular scope, petals); ES7210 + speaker FFT; tap cycles mode; PWR/BOOT voice off.
