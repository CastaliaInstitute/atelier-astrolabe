...
typedef enum {
  ASTROLABE_UI_FACE_FACULTY = 0,
  ASTROLABE_UI_FACE_CLASSIC_ANALOG,
  ...
  ASTROLABE_UI_FACE_SCALE_ATLAS,
  ASTROLABE_UI_FACE_ALMANAC,
  ASTROLABE_UI_FACE_SKY,
  ASTROLABE_UI_FACE_QUOTES,
  ASTROLABE_UI_FACE_LIVE_TRANSITS,
  ASTROLABE_UI_FACE_OCARINA,
  ASTROLABE_UI_FACE_PITCH_PIPE,
  ASTROLABE_UI_FACE_BONGO,
  ASTROLABE_UI_FACE_PIANO,
  ASTROLABE_UI_FACE_KALIMBA,
  ASTROLABE_UI_FACE_DRONE,
  ASTROLABE_UI_FACE_CHORD,
  ...
  ASTROLABE_UI_FACE_WATCHER,
  ASTROLABE_UI_FACE_LENORMAND,
  ASTROLABE_UI_FACE_PYTHIA,
  ASTROLABE_UI_FACE_GEOMANCY,
  ASTROLABE_UI_FACE_ENOCHIAN_ANGEL,
  ASTROLABE_UI_FACE_HID_TOUCHPAD,
  ASTROLABE_UI_FACE_BABEL_FISH,
  ASTROLABE_UI_FACE_DEATH_STAR,
  ASTROLABE_UI_FACE_SOLAR_ACTIVITY,
  ASTROLABE_UI_FACE_MAGNETOSPHERE,
  ASTROLABE_UI_FACE_SETTINGS,
  ASTROLABE_UI_FACE_POCKETWATCH,
